# 🇧🇷 SolidSign API - Exemplo de Integração: Assinatura CAdES (CMS) com PKCS#12 (certificado pré-importado) (TypeScript)
...
# 🇬🇧 SolidSign API - Integration Example: CAdES (CMS) Signing with PKCS#12 (pre-imported certificate) (TypeScript)
